...
音声記録の内容から漏れの無いように、話されていた内容は全て含めるようにしなさい。
ただし音声記録の文脈や雰囲気から予測できる項目の内容があれば記載しなさい。内容はなるべく詳細に、予測されることも含めながら内容を充実させなさい。
”記載なし”や”空白”の項目が無いようにしなさい。
...
- 該当項目に関する会話が全くなかった場合は「特記なし」と記載してください。それ以外の場合(ケアマネジャーが質問したが回答がなかった場合など)は項目を”空白”と記載してください。”空白”の場合は、なぜ空白か記しなさい(○○という質問に回答無し、や○○という質問をしたが回答が聞き取れなかった、など)
- 最後に重要度が高いのにもかかわらず、ヒアリングできていない事項について明記しなさい。例：「次回は○○さんの○○について、○○や○○などのヒアリングを行うと有意義なヒアリングになるでしょう。○○について聞くことも良いかもしれません。」など
